...
const DashboardHome = () => {
    ...
    return (
        <div className="mt-5">
            {!isAdmin && <div className="user-info">
                <img className="img-fluid border" src={user?.photoURL} alt="" />
                <h1>Welcome <span className="text-primary">{user?.displayName}</span></h1>
                <h5>{user?.email}</h5>
                <img className="img-fluid mt-4" src="https://image.freepik.com/free-vector/office-workers-analyzing-researching-business-data_74855-4445.jpg" alt="dashboard" />
            </div>
            }
            {isAdmin && <div>
                <div className="row mb-3">
                    <div className="col-xl-3 col-sm-6 py-2">
                        <div className="card text-white h-50">
                            <div className="card-body" style={{ backgroundColor: "#3B53DB", borderRadius: "5px" }}>
                    ...
                    <div className="col-xl-3 col-sm-6 py-2">
                        <div className="card text-white h-100">
                            <div className="card-body" style={{ backgroundColor: "#BD20D3", borderRadius: "5px" }}>
                                <div className="rotate">
                    ...
                    <div className="col-xl-3 col-sm-6 py-2">
                        <div className="card text-white h-100">
                            <div className="card-body" style={{ backgroundColor: "#F1682C", borderRadius: "5px" }}>
                                <div className="rotate">
                    ...
                    <div className="col-xl-3 col-sm-6 py-2">
                        <div className="card text-white h-100">
                            <div className="card-body" style={{ backgroundColor: "#0EB7FE", borderRadius: "5px" }}>
                                <div className="rotate">
