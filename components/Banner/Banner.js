            ...
            <Row>
                ...
                <Col lg={6} xs={12}>
                    ...
                    <article className='d-flex  mt-4'>
                        <p className='d-none d-xl-block' style={{ color: "#2AA2B0", transform: 'rotate(270deg)', fontWeight: 500, width: '50px' }}>- Installation
                        </p>
                        <h2 style={{ color: "#403535", fontWeight: 700 }}>
                            Aquarium Design, <br /> Manufacture, <br className='d-none d-md-block' /> Installation
                        </h2>
                    </article>

                    <article className='ms-xl-5'>
                        <p style={{ margin: '1.4em 0', color: '#8c8686', fontFamily: "roboto", width: '70%' }}>
                ...
                <Col lg={6} xs={12} className='order-1 order-lg-0'>
                    <article className='d-flex mt-5 aquarium-maintaince-banner' style={{ marginLeft: 110 }}>
                        <p className='d-none d-xl-block' style={{ color: "#2AA2B0", transform: 'rotate(270deg)', fontWeight: 500, width: '50px', marginTop: 50 }}>Maintenance
                    ...
                    <article style={{ marginLeft: "160px" }} className='mb-5 mb-lg-0 aquarium-maintaince-banner'>
                        <p style={{ margin: '1.4em 0', color: '#8c8686', fontFamily: "roboto", width: '95%' }}>
                ...
                <Col lg={6} xs={12} className='p-0 mt-5 mt-lg-0'>
                    <img width="585" height="416" style={{ marginTop: "-2px", marginLeft: "-15px" }} src="https://i.ibb.co/H2vqTV0/image-6.jpg" alt="" /></Col>
