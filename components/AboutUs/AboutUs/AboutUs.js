    ...
    return (
        ...
        <>
            ...
            <section style={{
                ...
                <h1 style={{ textAlign: 'center', color: "#fff", fontWeight: 700, fontFamily: "roboto", paddingTop: "14%" }}>About us</h1>
            </section>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-10 col-xl-6 ">
                            ...
                            <article className='ms-lg-5 about-text ps-lg-5 mt-5 pt-5'>
                                ...
                                <p className='d-none d-xl-block mb-0' style={{ color: "#2AA2B0", fontWeight: 500 }}>- who we are
                                </p>

                                <h2 className='fw-bold text-dark' style={{ fontSize: "2.118rem" }}>
                                    Specialists In Custom Fish <br /> Tanks, Luxury Aquarium <br /> Design And Installation
                                </h2>

                                <p style={{ color: "#8c8686", fontFamily: "roboto", width: "75%", marginTop: 30 }}>
